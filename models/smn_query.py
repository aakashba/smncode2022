...
from custom.inputmodule input InputModuleLayer
from custom.episodememory import EpisodicMemoryModuleLayer
...
class StatementMemoryNetworks_query:
    ...
    def create_model(self):
        ...
        memories = episodic_memory_module([facts,question])#using com sequence so far as quesiton
